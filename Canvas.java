...
public class Canvas
{
    ...
    public static Canvas getCanvas()
    {
        if(canvasSingleton == null) {
            canvasSingleton = new Canvas("World of Robots", 1000, 500, 
                                         Color.white);
        }
    ...
    public void setForegroundColor(String colorString)
    {
        if(colorString.equals("ROUGE")) {
            ...
            graphic.setColor(new Color(255, 128, 00));
        }else if(colorString.equals("MAGENTA")) {
            graphic.setColor(new Color(231, 148, 140));
        }else if(colorString.equals("VIOLET")) {
            graphic.setColor(new Color(128, 0, 128));
        }else if(colorString.equals("GRIS")) {
            graphic.setColor(new Color(158, 158, 158));
        }
        else {
            graphic.setColor(Color.black);
        }
